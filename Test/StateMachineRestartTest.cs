...
namespace NSFTest
{
    ...
    /// </summary>
    public class StateMachineRestartTest : NSFStateMachine, ITestInterface
    {
        #region Fields
        ...
        #region Constructors
        public StateMachineRestartTest(String name)
            : base(name, new NSFEventThread(name))
        {
            ...
            test1ReactionToEvent2 = new NSFInternalTransition("Test1ReactionToEvent2", this, event2, null, test1ReactionToEvent2Actions);
        ...
        private void test1ReactionToEvent2Actions(NSFStateMachineContext context)
        {
            queueEvent(event1);
        }
