...
namespace NSFTest
{
    ...
    /// </summary>
    public class ShallowHistoryTest : NSFStateMachine, ITestInterface
    {
        #region Fields
        ...
        private NSFShallowHistory state1History;
        ...
        #region Constructors
        public ShallowHistoryTest(String name)
            : base(name, new NSFEventThread(name))
        {
            ...
            //States
            test2InitialState = new NSFInitialState("InitialTest2", this);
            ...
            state1History = new NSFShallowHistory("State1History", state1);
